        ...
        <div className="relative">
          ...
          <div className="p-4 sm:p-8">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* AI Tool Buttons - Fixed size containers with off-white background */}
              <button
                onClick={() => handleOpenAI('claude')}
                disabled={isLoadingTranscript}
                className="h-14 w-14 rounded-xl shadow-lg transition-all duration-300 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0 border-0 flex items-center justify-center overflow-hidden bg-[#f5f5f5]"
                title="Open in Claude"
              >
                <img src="/logo/claude.png" alt="Claude" className="h-full w-full object-cover" />
              </button>
              ...
              >
                <img src="/logo/gemini.png" alt="Gemini" className="h-full w-full object-cover" />
              </button>
              ...
              >
                <img src="/logo/gpt.png" alt="ChatGPT" className="h-full w-full object-cover" />
              </button>
            </div>
          </div>
        </div>
